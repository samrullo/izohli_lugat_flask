...
COPY data/etc/systemd/system/izohli_lugat.service /etc/systemd/system/
COPY data/nginx/etc/nginx/sites-available/izohli_lugat_local.conf /etc/nginx/sites-available/
RUN ln -s /etc/nginx/sites-available/izohli_lugat_local.conf /etc/nginx/sites-enabled/
